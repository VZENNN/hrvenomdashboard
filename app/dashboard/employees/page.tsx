                    ...
                    <tbody>
                        {employees.length === 0 ? (
                            ...
                            employees.map((emp, index) => (
                                <tr key={emp.id} className="border-b border-slate-50 dark:border-slate-800 hover:bg-purple-50/50 dark:hover:bg-purple-900/10 transition-all duration-200 group">
                                    <td className="p-4">
                                        <div className="flex items-center gap-3">
                                            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-700 dark:to-slate-600 flex items-center justify-center font-bold text-slate-600 dark:text-slate-300 shadow-sm transition-transform duration-300 group-hover:scale-110">
                                    ...
                                    <td className="p-4">
                                        <span className={`px-2 py-1 rounded-full text-xs font-medium transition-all duration-200 ${emp.status === 'ACTIVE' ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400' : 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400'}`}>
                                            {emp.status}
                                        </span>
                                    </td>
